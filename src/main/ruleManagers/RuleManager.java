...
public class RuleManager {
    ...
    public boolean isOptionAvailable() {
        ...
        return (isRuleValid(new StraitRule(), diceSetMap) || isRuleValid(new SetRule(), diceSetMap) || isRuleValid(new MultipleRule(), diceSetMap) || isRuleValid(new SingleRule(1), diceSetMap) || isRuleValid(new SingleRule(5), diceSetMap));
    }
